...
const ProfileOnboarding: React.FC<ProfileOnboardingProps> = ({ onComplete }) => {
  ...
  const [step, setStep] = useState(-1); // -1: Role, 0: Phone, 1: Info, 2: NIN, 3: Car
        ...
        {step === 0 && (
          <div className="space-y-8 animate-in slide-in-from-right-4">
             ...
             <div className="space-y-4">
                ...
                <button onClick={() => setStep(1)} disabled={!formData.phone} className="w-full bg-emerald-600 text-white p-5 rounded-2xl font-black text-xl shadow-xl shadow-emerald-200 disabled:opacity-50">Continue</button>
             </div>
          </div>
        )}
